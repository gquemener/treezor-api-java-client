...
public class ApiClient {
    ...
    new ServerConfiguration(
      "https://<your-company-name>.sandbox.treezor.co",
      "Sandbox environment",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://<your-company-name>.api.treezor.co",
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://connect.sandbox.treezor.co/oauth/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/24.11.21/java");
