...
public class GetPayouts200ResponsePayoutsInner {
  ...
  public GetPayouts200ResponsePayoutsInner() {
  }

  public GetPayouts200ResponsePayoutsInner payoutId(@javax.annotation.Nullable Integer payoutId) {
  ...
  public GetPayouts200ResponsePayoutsInner payoutTag(@javax.annotation.Nullable String payoutTag) {
  ...
  public GetPayouts200ResponsePayoutsInner payoutStatus(@javax.annotation.Nullable PayoutStatusEnum payoutStatus) {
  ...
  public GetPayouts200ResponsePayoutsInner payoutTypeId(@javax.annotation.Nullable Integer payoutTypeId) {
  ...
  public GetPayouts200ResponsePayoutsInner payoutType(@javax.annotation.Nullable PayoutTypeEnum payoutType) {
  ...
  public GetPayouts200ResponsePayoutsInner walletId(@javax.annotation.Nullable Integer walletId) {
  ...
  public GetPayouts200ResponsePayoutsInner payoutDate(@javax.annotation.Nullable String payoutDate) {
  ...
  public GetPayouts200ResponsePayoutsInner walletEventName(@javax.annotation.Nullable String walletEventName) {
  ...
  public GetPayouts200ResponsePayoutsInner walletAlias(@javax.annotation.Nullable String walletAlias) {
  ...
  public GetPayouts200ResponsePayoutsInner userFirstname(@javax.annotation.Nullable String userFirstname) {
  ...
  public GetPayouts200ResponsePayoutsInner userLastname(@javax.annotation.Nullable String userLastname) {
  ...
  public GetPayouts200ResponsePayoutsInner userId(@javax.annotation.Nullable Integer userId) {
    this.userId = userId;
    return this;
  }
  ...
  public GetPayouts200ResponsePayoutsInner beneficiaryId(@javax.annotation.Nullable Integer beneficiaryId) {
  ...
  public GetPayouts200ResponsePayoutsInner uniqueMandateReference(@javax.annotation.Nullable String uniqueMandateReference) {
  ...
  public GetPayouts200ResponsePayoutsInner bankaccountIBAN(@javax.annotation.Nullable String bankaccountIBAN) {
  ...
  public GetPayouts200ResponsePayoutsInner virtualIbanId(@javax.annotation.Nullable Integer virtualIbanId) {
  ...
  public GetPayouts200ResponsePayoutsInner virtualIbanReference(@javax.annotation.Nullable String virtualIbanReference) {
  ...
  public GetPayouts200ResponsePayoutsInner label(@javax.annotation.Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public GetPayouts200ResponsePayoutsInner endToEndId(@javax.annotation.Nullable String endToEndId) {
  ...
  public GetPayouts200ResponsePayoutsInner reasonCode(@javax.annotation.Nullable String reasonCode) {
  ...
  public GetPayouts200ResponsePayoutsInner reasonDescription(@javax.annotation.Nullable String reasonDescription) {
  ...
  public GetPayouts200ResponsePayoutsInner codeStatus(@javax.annotation.Nullable String codeStatus) {
  ...
  public GetPayouts200ResponsePayoutsInner informationStatus(@javax.annotation.Nullable String informationStatus) {
  ...
  public GetPayouts200ResponsePayoutsInner supportingFileLink(@javax.annotation.Nullable String supportingFileLink) {
  ...
  public GetPayouts200ResponsePayoutsInner amount(@javax.annotation.Nullable String amount) {
    this.amount = amount;
    return this;
  }
  ...
  public GetPayouts200ResponsePayoutsInner currency(@javax.annotation.Nullable String currency) {
  ...
  public GetPayouts200ResponsePayoutsInner partnerFee(@javax.annotation.Nullable String partnerFee) {
  ...
  public GetPayouts200ResponsePayoutsInner createdDate(@javax.annotation.Nullable String createdDate) {
  ...
  public GetPayouts200ResponsePayoutsInner modifiedDate(@javax.annotation.Nullable String modifiedDate) {
  ...
  public GetPayouts200ResponsePayoutsInner totalRows(@javax.annotation.Nullable Integer totalRows) {
  ...
  public GetPayouts200ResponsePayoutsInner metadata(@javax.annotation.Nullable Object metadata) {
  ...
  public boolean equals(Object o) {
    ...
    GetPayouts200ResponsePayoutsInner getPayouts200ResponsePayoutsInner = (GetPayouts200ResponsePayoutsInner) o;
    return Objects.equals(this.payoutId, getPayouts200ResponsePayoutsInner.payoutId) &&
        Objects.equals(this.payoutTag, getPayouts200ResponsePayoutsInner.payoutTag) &&
        Objects.equals(this.payoutStatus, getPayouts200ResponsePayoutsInner.payoutStatus) &&
        Objects.equals(this.payoutTypeId, getPayouts200ResponsePayoutsInner.payoutTypeId) &&
        Objects.equals(this.payoutType, getPayouts200ResponsePayoutsInner.payoutType) &&
        Objects.equals(this.walletId, getPayouts200ResponsePayoutsInner.walletId) &&
        Objects.equals(this.payoutDate, getPayouts200ResponsePayoutsInner.payoutDate) &&
        Objects.equals(this.walletEventName, getPayouts200ResponsePayoutsInner.walletEventName) &&
        Objects.equals(this.walletAlias, getPayouts200ResponsePayoutsInner.walletAlias) &&
        Objects.equals(this.userFirstname, getPayouts200ResponsePayoutsInner.userFirstname) &&
        Objects.equals(this.userLastname, getPayouts200ResponsePayoutsInner.userLastname) &&
        Objects.equals(this.userId, getPayouts200ResponsePayoutsInner.userId) &&
        Objects.equals(this.beneficiaryId, getPayouts200ResponsePayoutsInner.beneficiaryId) &&
        Objects.equals(this.uniqueMandateReference, getPayouts200ResponsePayoutsInner.uniqueMandateReference) &&
        Objects.equals(this.bankaccountIBAN, getPayouts200ResponsePayoutsInner.bankaccountIBAN) &&
        Objects.equals(this.virtualIbanId, getPayouts200ResponsePayoutsInner.virtualIbanId) &&
        Objects.equals(this.virtualIbanReference, getPayouts200ResponsePayoutsInner.virtualIbanReference) &&
        Objects.equals(this.label, getPayouts200ResponsePayoutsInner.label) &&
        Objects.equals(this.endToEndId, getPayouts200ResponsePayoutsInner.endToEndId) &&
        Objects.equals(this.reasonCode, getPayouts200ResponsePayoutsInner.reasonCode) &&
        Objects.equals(this.reasonDescription, getPayouts200ResponsePayoutsInner.reasonDescription) &&
        Objects.equals(this.codeStatus, getPayouts200ResponsePayoutsInner.codeStatus) &&
        Objects.equals(this.informationStatus, getPayouts200ResponsePayoutsInner.informationStatus) &&
        Objects.equals(this.supportingFileLink, getPayouts200ResponsePayoutsInner.supportingFileLink) &&
        Objects.equals(this.amount, getPayouts200ResponsePayoutsInner.amount) &&
        Objects.equals(this.currency, getPayouts200ResponsePayoutsInner.currency) &&
        Objects.equals(this.partnerFee, getPayouts200ResponsePayoutsInner.partnerFee) &&
        Objects.equals(this.createdDate, getPayouts200ResponsePayoutsInner.createdDate) &&
        Objects.equals(this.modifiedDate, getPayouts200ResponsePayoutsInner.modifiedDate) &&
        Objects.equals(this.totalRows, getPayouts200ResponsePayoutsInner.totalRows) &&
        Objects.equals(this.metadata, getPayouts200ResponsePayoutsInner.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPayouts200ResponsePayoutsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPayouts200ResponsePayoutsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPayouts200ResponsePayoutsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPayouts200ResponsePayoutsInner is not found in the empty JSON string", GetPayouts200ResponsePayoutsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPayouts200ResponsePayoutsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPayouts200ResponsePayoutsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPayouts200ResponsePayoutsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPayouts200ResponsePayoutsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPayouts200ResponsePayoutsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPayouts200ResponsePayoutsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPayouts200ResponsePayoutsInner>() {
           @Override
           public void write(JsonWriter out, GetPayouts200ResponsePayoutsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPayouts200ResponsePayoutsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPayouts200ResponsePayoutsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPayouts200ResponsePayoutsInner
   * @throws IOException if the JSON string is invalid with respect to GetPayouts200ResponsePayoutsInner
   */
  public static GetPayouts200ResponsePayoutsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPayouts200ResponsePayoutsInner.class);
  }

  /**
   * Convert an instance of GetPayouts200ResponsePayoutsInner to an JSON string
   *
   * @return JSON string
   */
