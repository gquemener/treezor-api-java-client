...
public class PayinRefund {
  ...
  public static final String SERIALIZED_NAME_REASON_TMS = "reasonTms";
  @SerializedName(SERIALIZED_NAME_REASON_TMS)
  @javax.annotation.Nullable
  private String reasonTms;
  ...
  public static final String SERIALIZED_NAME_IBAN_FULL_NAME = "ibanFullName";
  @SerializedName(SERIALIZED_NAME_IBAN_FULL_NAME)
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payinId, payinRefund.payinId) &&
        Objects.equals(this.codeStatus, payinRefund.codeStatus) &&
        Objects.equals(this.informationStatus, payinRefund.informationStatus) &&
        Objects.equals(this.reasonTms, payinRefund.reasonTms) &&
        Objects.equals(this.payinTag, payinRefund.payinTag) &&
        Objects.equals(this.messageToUser, payinRefund.messageToUser) &&
        Objects.equals(this.ibanFullName, payinRefund.ibanFullName) &&
        Objects.equals(this.dbtrIBAN, payinRefund.dbtrIBAN) &&
        Objects.equals(this.ibanTxEndToEndId, payinRefund.ibanTxEndToEndId) &&
        Objects.equals(this.mandateId, payinRefund.mandateId) &&
        Objects.equals(this.debtorName, payinRefund.debtorName) &&
        Objects.equals(this.uniqueMandateReference, payinRefund.uniqueMandateReference) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(payinId, codeStatus, informationStatus, reasonTms, payinTag, messageToUser, ibanFullName, dbtrIBAN, ibanTxEndToEndId, mandateId, debtorName, uniqueMandateReference, additionalData);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayinRefund
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayinRefund.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayinRefund is not found in the empty JSON string", PayinRefund.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayinRefund.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayinRefund` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("reasonTms") != null && !jsonObj.get("reasonTms").isJsonNull()) && !jsonObj.get("reasonTms").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reasonTms` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reasonTms").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayinRefund.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayinRefund' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayinRefund> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayinRefund.class));

       return (TypeAdapter<T>) new TypeAdapter<PayinRefund>() {
           @Override
           public void write(JsonWriter out, PayinRefund value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PayinRefund read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PayinRefund given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PayinRefund
   * @throws IOException if the JSON string is invalid with respect to PayinRefund
   */
  public static PayinRefund fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayinRefund.class);
  }

  /**
   * Convert an instance of PayinRefund to an JSON string
   *
   * @return JSON string
   */
