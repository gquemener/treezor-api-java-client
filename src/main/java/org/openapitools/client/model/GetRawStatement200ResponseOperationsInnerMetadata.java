...
public class GetRawStatement200ResponseOperationsInnerMetadata extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetRawStatement200ResponseOperationsInnerMetadata.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetRawStatement200ResponseOperationsInnerMetadata.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetRawStatement200ResponseOperationsInnerMetadata' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetRawStatement200ResponseOperationsInnerMetadata>() {
                @Override
                public void write(JsonWriter out, GetRawStatement200ResponseOperationsInnerMetadata value) throws IOException {
                ...
                @Override
                public GetRawStatement200ResponseOperationsInnerMetadata read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetRawStatement200ResponseOperationsInnerMetadata ret = new GetRawStatement200ResponseOperationsInnerMetadata();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetRawStatement200ResponseOperationsInnerMetadata: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetRawStatement200ResponseOperationsInnerMetadata(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetRawStatement200ResponseOperationsInnerMetadata.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetRawStatement200ResponseOperationsInnerMetadata
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for GetRawStatement200ResponseOperationsInnerMetadata with oneOf schemas: CardPayment, Chargeback, Payin, PayinRefund, Payout, PayoutRefund, Transfer. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of GetRawStatement200ResponseOperationsInnerMetadata given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetRawStatement200ResponseOperationsInnerMetadata
     * @throws IOException if the JSON string is invalid with respect to GetRawStatement200ResponseOperationsInnerMetadata
     */
    public static GetRawStatement200ResponseOperationsInnerMetadata fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetRawStatement200ResponseOperationsInnerMetadata.class);
    }

    /**
     * Convert an instance of GetRawStatement200ResponseOperationsInnerMetadata to an JSON string
     *
     * @return JSON string
     */
