...
public class AuthorizationDeleteResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthorizationDeleteResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthorizationDeleteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthorizationDeleteResponse is not found in the empty JSON string", AuthorizationDeleteResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthorizationDeleteResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthorizationDeleteResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorizationDeleteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorizationDeleteResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorizationDeleteResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorizationDeleteResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorizationDeleteResponse>() {
           @Override
           public void write(JsonWriter out, AuthorizationDeleteResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthorizationDeleteResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthorizationDeleteResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthorizationDeleteResponse
   * @throws IOException if the JSON string is invalid with respect to AuthorizationDeleteResponse
   */
  public static AuthorizationDeleteResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorizationDeleteResponse.class);
  }

  /**
   * Convert an instance of AuthorizationDeleteResponse to an JSON string
   *
   * @return JSON string
   */
