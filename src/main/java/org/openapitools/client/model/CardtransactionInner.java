...
public class CardtransactionInner {
  ...
  public CardtransactionInner() {
  }

  public CardtransactionInner cardtransactionId(@javax.annotation.Nullable Integer cardtransactionId) {
  ...
  public CardtransactionInner cardId(@javax.annotation.Nullable Integer cardId) {
    this.cardId = cardId;
    return this;
  }
  ...
  public CardtransactionInner walletId(@javax.annotation.Nullable Integer walletId) {
  ...
  public CardtransactionInner acquirerId(@javax.annotation.Nullable Integer acquirerId) {
  ...
  public CardtransactionInner walletCurrency(@javax.annotation.Nullable String walletCurrency) {
  ...
  public CardtransactionInner merchantId(@javax.annotation.Nullable String merchantId) {
  ...
  public CardtransactionInner merchantName(@javax.annotation.Nullable String merchantName) {
  ...
  public CardtransactionInner merchantAddress(@javax.annotation.Nullable String merchantAddress) {
  ...
  public CardtransactionInner merchantCity(@javax.annotation.Nullable String merchantCity) {
  ...
  public CardtransactionInner merchantCountry(@javax.annotation.Nullable String merchantCountry) {
  ...
  public CardtransactionInner mccCode(@javax.annotation.Nullable String mccCode) {
  ...
  public CardtransactionInner paymentLocalTime(@javax.annotation.Nullable String paymentLocalTime) {
  ...
  public CardtransactionInner publicToken(@javax.annotation.Nullable String publicToken) {
  ...
  public CardtransactionInner paymentAmount(@javax.annotation.Nullable String paymentAmount) {
  ...
  public CardtransactionInner paymentCurrency(@javax.annotation.Nullable String paymentCurrency) {
  ...
  public CardtransactionInner fees(@javax.annotation.Nullable String fees) {
    this.fees = fees;
    return this;
  }
  ...
  public CardtransactionInner paymentCountry(@javax.annotation.Nullable String paymentCountry) {
  ...
  public CardtransactionInner paymentId(@javax.annotation.Nullable String paymentId) {
  ...
  public CardtransactionInner paymentStatus(@javax.annotation.Nullable String paymentStatus) {
  ...
  public CardtransactionInner paymentLocalAmount(@javax.annotation.Nullable String paymentLocalAmount) {
  ...
  public CardtransactionInner paymentLocalDate(@javax.annotation.Nullable String paymentLocalDate) {
  ...
  public CardtransactionInner is3DS(@javax.annotation.Nullable Boolean is3DS) {
    this.is3DS = is3DS;
    return this;
  }
  ...
  public CardtransactionInner posCardholderPresence(@javax.annotation.Nullable String posCardholderPresence) {
  ...
  public CardtransactionInner posPostcode(@javax.annotation.Nullable String posPostcode) {
  ...
  public CardtransactionInner posCountry(@javax.annotation.Nullable String posCountry) {
  ...
  public CardtransactionInner posTerminalId(@javax.annotation.Nullable String posTerminalId) {
  ...
  public CardtransactionInner posCardPresence(@javax.annotation.Nullable String posCardPresence) {
  ...
  public CardtransactionInner panEntryMethod(@javax.annotation.Nullable String panEntryMethod) {
  ...
  public CardtransactionInner authorizationNote(@javax.annotation.Nullable String authorizationNote) {
  ...
  public CardtransactionInner authorizationResponseCode(@javax.annotation.Nullable String authorizationResponseCode) {
  ...
  public CardtransactionInner authorizationIssuerId(@javax.annotation.Nullable String authorizationIssuerId) {
  ...
  public CardtransactionInner authorizationIssuerTime(@javax.annotation.Nullable String authorizationIssuerTime) {
  ...
  public CardtransactionInner authorizationMti(@javax.annotation.Nullable String authorizationMti) {
  ...
  public CardtransactionInner authorizedBalance(@javax.annotation.Nullable String authorizedBalance) {
  ...
  public CardtransactionInner limitAtmYear(@javax.annotation.Nullable String limitAtmYear) {
  ...
  public CardtransactionInner limitAtmMonth(@javax.annotation.Nullable String limitAtmMonth) {
  ...
  public CardtransactionInner limitAtmWeek(@javax.annotation.Nullable String limitAtmWeek) {
  ...
  public CardtransactionInner limitAtmDay(@javax.annotation.Nullable String limitAtmDay) {
  ...
  public CardtransactionInner limitAtmAll(@javax.annotation.Nullable String limitAtmAll) {
  ...
  public CardtransactionInner limitPaymentYear(@javax.annotation.Nullable String limitPaymentYear) {
  ...
  public CardtransactionInner limitPaymentMonth(@javax.annotation.Nullable String limitPaymentMonth) {
  ...
  public CardtransactionInner limitPaymentWeek(@javax.annotation.Nullable String limitPaymentWeek) {
  ...
  public CardtransactionInner limitPaymentDay(@javax.annotation.Nullable String limitPaymentDay) {
  ...
  public CardtransactionInner limitPaymentAll(@javax.annotation.Nullable String limitPaymentAll) {
  ...
  public CardtransactionInner totalLimitAtmYear(@javax.annotation.Nullable String totalLimitAtmYear) {
  ...
  public CardtransactionInner totalLimitAtmMonth(@javax.annotation.Nullable String totalLimitAtmMonth) {
  ...
  public CardtransactionInner totalLimitAtmWeek(@javax.annotation.Nullable String totalLimitAtmWeek) {
  ...
  public CardtransactionInner totalLimitAtmDay(@javax.annotation.Nullable String totalLimitAtmDay) {
  ...
  public CardtransactionInner totalLimitAtmAll(@javax.annotation.Nullable String totalLimitAtmAll) {
  ...
  public CardtransactionInner totalLimitPaymentYear(@javax.annotation.Nullable String totalLimitPaymentYear) {
  ...
  public CardtransactionInner totalLimitPaymentMonth(@javax.annotation.Nullable String totalLimitPaymentMonth) {
  ...
  public CardtransactionInner totalLimitPaymentWeek(@javax.annotation.Nullable String totalLimitPaymentWeek) {
  ...
  public CardtransactionInner totalLimitPaymentDay(@javax.annotation.Nullable String totalLimitPaymentDay) {
  ...
  public CardtransactionInner totalLimitPaymentAll(@javax.annotation.Nullable String totalLimitPaymentAll) {
  ...
  public CardtransactionInner cardDigitalizationExternalId(@javax.annotation.Nullable String cardDigitalizationExternalId) {
  ...
  public CardtransactionInner totalRows(@javax.annotation.Nullable Integer totalRows) {
  ...
  public CardtransactionInner optimizedMerchantName(@javax.annotation.Nullable String optimizedMerchantName) {
  ...
  public CardtransactionInner merchantLogo(@javax.annotation.Nullable String merchantLogo) {
  ...
  public CardtransactionInner merchantCategory(@javax.annotation.Nullable String merchantCategory) {
  ...
  public CardtransactionInner transactionSubtype(@javax.annotation.Nullable TransactionSubtypeEnum transactionSubtype) {
  ...
  public CardtransactionInner _3dsExemptionType(@javax.annotation.Nullable String _3dsExemptionType) {
  ...
  public CardtransactionInner receiverData(@javax.annotation.Nullable String receiverData) {
  ...
  public CardtransactionInner senderData(@javax.annotation.Nullable String senderData) {
  ...
  public CardtransactionInner transactionTypeIdentifier(@javax.annotation.Nullable String transactionTypeIdentifier) {
  ...
  public CardtransactionInner localMerchantId(@javax.annotation.Nullable String localMerchantId) {
  ...
  public boolean equals(Object o) {
    ...
    CardtransactionInner cardtransactionInner = (CardtransactionInner) o;
    return Objects.equals(this.cardtransactionId, cardtransactionInner.cardtransactionId) &&
        Objects.equals(this.cardId, cardtransactionInner.cardId) &&
        Objects.equals(this.walletId, cardtransactionInner.walletId) &&
        Objects.equals(this.acquirerId, cardtransactionInner.acquirerId) &&
        Objects.equals(this.walletCurrency, cardtransactionInner.walletCurrency) &&
        Objects.equals(this.merchantId, cardtransactionInner.merchantId) &&
        Objects.equals(this.merchantName, cardtransactionInner.merchantName) &&
        Objects.equals(this.merchantAddress, cardtransactionInner.merchantAddress) &&
        Objects.equals(this.merchantCity, cardtransactionInner.merchantCity) &&
        Objects.equals(this.merchantCountry, cardtransactionInner.merchantCountry) &&
        Objects.equals(this.mccCode, cardtransactionInner.mccCode) &&
        Objects.equals(this.paymentLocalTime, cardtransactionInner.paymentLocalTime) &&
        Objects.equals(this.publicToken, cardtransactionInner.publicToken) &&
        Objects.equals(this.paymentAmount, cardtransactionInner.paymentAmount) &&
        Objects.equals(this.paymentCurrency, cardtransactionInner.paymentCurrency) &&
        Objects.equals(this.fees, cardtransactionInner.fees) &&
        Objects.equals(this.paymentCountry, cardtransactionInner.paymentCountry) &&
        Objects.equals(this.paymentId, cardtransactionInner.paymentId) &&
        Objects.equals(this.paymentStatus, cardtransactionInner.paymentStatus) &&
        Objects.equals(this.paymentLocalAmount, cardtransactionInner.paymentLocalAmount) &&
        Objects.equals(this.paymentLocalDate, cardtransactionInner.paymentLocalDate) &&
        Objects.equals(this.is3DS, cardtransactionInner.is3DS) &&
        Objects.equals(this.posCardholderPresence, cardtransactionInner.posCardholderPresence) &&
        Objects.equals(this.posPostcode, cardtransactionInner.posPostcode) &&
        Objects.equals(this.posCountry, cardtransactionInner.posCountry) &&
        Objects.equals(this.posTerminalId, cardtransactionInner.posTerminalId) &&
        Objects.equals(this.posCardPresence, cardtransactionInner.posCardPresence) &&
        Objects.equals(this.panEntryMethod, cardtransactionInner.panEntryMethod) &&
        Objects.equals(this.authorizationNote, cardtransactionInner.authorizationNote) &&
        Objects.equals(this.authorizationResponseCode, cardtransactionInner.authorizationResponseCode) &&
        Objects.equals(this.authorizationIssuerId, cardtransactionInner.authorizationIssuerId) &&
        Objects.equals(this.authorizationIssuerTime, cardtransactionInner.authorizationIssuerTime) &&
        Objects.equals(this.authorizationMti, cardtransactionInner.authorizationMti) &&
        Objects.equals(this.authorizedBalance, cardtransactionInner.authorizedBalance) &&
        Objects.equals(this.limitAtmYear, cardtransactionInner.limitAtmYear) &&
        Objects.equals(this.limitAtmMonth, cardtransactionInner.limitAtmMonth) &&
        Objects.equals(this.limitAtmWeek, cardtransactionInner.limitAtmWeek) &&
        Objects.equals(this.limitAtmDay, cardtransactionInner.limitAtmDay) &&
        Objects.equals(this.limitAtmAll, cardtransactionInner.limitAtmAll) &&
        Objects.equals(this.limitPaymentYear, cardtransactionInner.limitPaymentYear) &&
        Objects.equals(this.limitPaymentMonth, cardtransactionInner.limitPaymentMonth) &&
        Objects.equals(this.limitPaymentWeek, cardtransactionInner.limitPaymentWeek) &&
        Objects.equals(this.limitPaymentDay, cardtransactionInner.limitPaymentDay) &&
        Objects.equals(this.limitPaymentAll, cardtransactionInner.limitPaymentAll) &&
        Objects.equals(this.totalLimitAtmYear, cardtransactionInner.totalLimitAtmYear) &&
        Objects.equals(this.totalLimitAtmMonth, cardtransactionInner.totalLimitAtmMonth) &&
        Objects.equals(this.totalLimitAtmWeek, cardtransactionInner.totalLimitAtmWeek) &&
        Objects.equals(this.totalLimitAtmDay, cardtransactionInner.totalLimitAtmDay) &&
        Objects.equals(this.totalLimitAtmAll, cardtransactionInner.totalLimitAtmAll) &&
        Objects.equals(this.totalLimitPaymentYear, cardtransactionInner.totalLimitPaymentYear) &&
        Objects.equals(this.totalLimitPaymentMonth, cardtransactionInner.totalLimitPaymentMonth) &&
        Objects.equals(this.totalLimitPaymentWeek, cardtransactionInner.totalLimitPaymentWeek) &&
        Objects.equals(this.totalLimitPaymentDay, cardtransactionInner.totalLimitPaymentDay) &&
        Objects.equals(this.totalLimitPaymentAll, cardtransactionInner.totalLimitPaymentAll) &&
        Objects.equals(this.cardDigitalizationExternalId, cardtransactionInner.cardDigitalizationExternalId) &&
        Objects.equals(this.totalRows, cardtransactionInner.totalRows) &&
        Objects.equals(this.optimizedMerchantName, cardtransactionInner.optimizedMerchantName) &&
        Objects.equals(this.merchantLogo, cardtransactionInner.merchantLogo) &&
        Objects.equals(this.merchantCategory, cardtransactionInner.merchantCategory) &&
        Objects.equals(this.transactionSubtype, cardtransactionInner.transactionSubtype) &&
        Objects.equals(this._3dsExemptionType, cardtransactionInner._3dsExemptionType) &&
        Objects.equals(this.receiverData, cardtransactionInner.receiverData) &&
        Objects.equals(this.senderData, cardtransactionInner.senderData) &&
        Objects.equals(this.transactionTypeIdentifier, cardtransactionInner.transactionTypeIdentifier) &&
        Objects.equals(this.localMerchantId, cardtransactionInner.localMerchantId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CardtransactionInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CardtransactionInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardtransactionInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardtransactionInner is not found in the empty JSON string", CardtransactionInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CardtransactionInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardtransactionInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardtransactionInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardtransactionInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardtransactionInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardtransactionInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CardtransactionInner>() {
           @Override
           public void write(JsonWriter out, CardtransactionInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CardtransactionInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CardtransactionInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CardtransactionInner
   * @throws IOException if the JSON string is invalid with respect to CardtransactionInner
   */
  public static CardtransactionInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardtransactionInner.class);
  }

  /**
   * Convert an instance of CardtransactionInner to an JSON string
   *
   * @return JSON string
   */
